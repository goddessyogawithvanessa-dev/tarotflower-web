...
![](https://vanessahylande960269070.files.wordpress.com/2020/01/img_20181027_150416.png?w=1024)

"Darkening Moon" by Vanessa Hylande
...
*Anything* can be overcome, and made even better in the end. It requires patience, honor, selflessness, and complete [surrender](https://vanessahylande.com/2020/01/13/the-power-of-surrender/). This is where true strength lies. This is what makes up our humanity. Reptiles attack, kill, destroy, and conquer. Let them destroy each other if they must. But we don't need to be a part of it.
...
The only thing we will all have with us when we pass to the other side is the [authentic truth](https://vanessahylande.com/2020/01/07/iii-resistance-is-futile-authenticity-rules/). Nobody can fool themselves in death, for it is the bringer of [Judgment](https://vanessahylande.com/2020/01/11/the-trumpets-of-judgment-sound/). Believe in God or not, we all know the truth even if we lie to the world or ourselves.
...
The condor is finally taking flight and [The Hierophant](https://www.psychicguild.com/tarot/card-meanings/the-hierophant) can go on a long, long hiatus. The Age of [The High Priestess](https://www.psychicguild.com/tarot/card-meanings/the-high-priestess) is here. We have waited long enough. The old ways won't fix this, so together we will take it and make it ours. And we will make it beautifully.
